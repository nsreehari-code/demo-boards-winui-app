...
internal sealed class ReducerJsHost : IDisposable
{
    private readonly V8ScriptEngine engine;
    private readonly SemaphoreSlim engineLock = new(1, 1);

    public ReducerJsHost()
    {
...
");
        ...
        engine.Execute("compute-jsonata.js", File.ReadAllText(Path.Combine(baseDir, "Lib", "compute-jsonata.js")));
        engine.Execute("board-sse-state.js", File.ReadAllText(Path.Combine(baseDir, "SseReducer", "board-sse-state.js")));
        engine.Execute("board-sse-reducer-host.js", File.ReadAllText(Path.Combine(baseDir, "SseReducer", "board-sse-reducer-host.js")));
    }
